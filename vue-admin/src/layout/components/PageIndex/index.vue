<template>
  <div class="page">
    <span class="page-block center" @click="pageChange(1)">{{ "«" }}</span>
    ...
    <span
      ...
      >{{ pageNum }}</span
    >
    <span v-if="pageMax - pageList[2] > 2" class="page-block center">...</span>
    <span class="page-block center" @click="pageChange(pageMax)">{{
      "»"
    }}</span>
  </div>
</template>
