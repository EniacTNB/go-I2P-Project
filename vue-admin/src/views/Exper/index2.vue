  ...
  <div class="app-container">
    ...
    >
      ...
      <!-- <el-table-column label="User" width="150" align="center">
       ...
       -->
      <el-table-column label="节点可达率" width="100" align="center">
        <template slot-scope="scope">
          {{ scope.row.Address }}
        </template>
      </el-table-column>
      <el-table-column label="通信延迟" width="150" align="center">
        <template slot-scope="scope">
          {{ scope.row.routerinfo }}
        </template>
      </el-table-column>
      <!-- <el-table-column label="可靠性评分" width="250" align="center">
        <template slot-scope="scope">
          {{ scope.row.IP }}
        </template>
      </el-table-column> -->
      <el-table-column label="安全性评分" width="400" align="center">
        <template slot-scope="scope">
          {{ scope.row.ses }}
        </template>
      </el-table-column>
...
// 选中的button更改颜色，其余的都更改为灰色
    ...
    //   });
    this.list = [
    {'index':1,'name':'TestRouterSelectionAlgorithm','IP':'Admin','Address':'98.3','ses':'2000: 0.0893 4000:0.0265 6000:0.0930 8000:0.1255','routerinfo':10747,'time':1645781486000},
    ]
    },
    getDisplayTime(ts) {
