<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="ExperName" width="250" align="center">
        <template slot-scope="scope">
          {{ scope.row.name }}
        </template>
      </el-table-column>
      ...
      <el-table-column label="ExperimentTime" width="150" align="center">
        <template slot-scope="scope">
          {{ scope.row.Address }}
        </template>
      </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      pageList: [], // 页码列表
    //   index:"success",
      indexList:["success","success","success","success"],
      valueList:["已完成","已完成","已完成","已完成"]
    };
  },
  created() {
...
// 选中的button更改颜色，其余的都更改为灰色
    ...
    //     // return response;
    //   });
    this.list = [{'index':1,'name':'TestRouterKeepingAlgorithm','IP':'Admin','Address':'30','routerinfo':15883,'time':1643583197000},
    {'index':1,'name':'TestRouterSelectionAlgorithm','IP':'Admin','Address':'30','routerinfo':20967,'time':1645781486000},
    {'index':1,'name':'Testttt','IP':'Eniac','Address':'180','routerinfo':22494,'time':1643481973000},
    {'index':1,'name':'a;lkdsjf;','IP':'Eniac','Address':'180','routerinfo':305772,'time':1643481992700},]
    },
    getDisplayTime(ts) {
